...
CASES = [
    ...
    ("btop", "linux", "amd64", "btop-x86_64-unknown-linux-musl.tar.gz"),
    ("btop", "linux", "arm64", "btop-aarch64-unknown-linux-musl.tar.gz"),
    ("btop", "linux", "i686", "btop-i686-unknown-linux-musl.tar.gz"),
    ...
    ("rg", "linux", "arm64", "ripgrep-{version}-aarch64-unknown-linux-musl.tar.gz"),
