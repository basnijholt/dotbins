...
🛠️ dotbins initialized tools directory structure in `tools_dir=~/.dotbins5`
📝 Generated shell scripts in ~/.dotbins5/shell/
🔍 Add this to your shell config:
👉   Bash:    source $HOME/.dotbins5/shell/bash.sh
👉   Zsh:     source $HOME/.dotbins5/shell/zsh.sh
👉   Fish:    source $HOME/.dotbins5/shell/fish.fish
👉   Nushell: source $HOME/.dotbins5/shell/nushell.nu
📝 Generated README at ~/.dotbins5/README.md
```
